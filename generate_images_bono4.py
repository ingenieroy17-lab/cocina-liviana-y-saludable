...
def main():
    ...
    md_path = r"r:\ROY\FACULTAD Y TRABAJOS\EMPRENDIMIENTOS\IA\Antigravity Projects\RECETARIO SALUDABLE\prompts-bono4.md"
    output_dir = r"R:\ROY\FACULTAD Y TRABAJOS\EMPRENDIMIENTOS\IA\Antigravity Projects\RECETARIO SALUDABLE\assets\images\imagenes dentro de libros\bono4 - Recetas sin Harinas - fotos"
    ...
    print(f"Loaded {len(recipes)} recipes from markdown. Filtered to run {len(recipes_to_run)} recipes (1 to 30).")
